...
typedef int8_t (*pozyx_com_fptr_t)(uint8_t dev_id, uint8_t reg_addr,
		uint8_t *data, uint16_t len);

typedef struct Pozyx_dev {
	uint8_t firmware_ver;
	uint8_t hardware_ver;
	/*! Read function pointer */
	pozyx_com_fptr_t read;
	/*! Write function pointer */
	pozyx_com_fptr_t write;
} Pozyx_dev_t;
...
public:
...
#else
    static bool waitForFlag_safe(uint8_t interrupt_flag, int timeout_ms, uint8_t *interrupt);
#endif
...
#else
    static int remoteRegFunctionWithoutCheck(uint16_t destination, uint8_t reg_address, uint8_t *params, int param_size, uint8_t *pData, int size);
#endif
...
#else
    static bool waitForFlag(uint8_t interrupt_flag, int timeout_ms, uint8_t *interrupt);
#endif
    ...
    * @retval #POZYX_FAILURE function failed.
    */
    int Pozyx_init(Pozyx_dev_t *i2c_dev);
...
#else
    static int getRead(uint8_t reg_address, uint8_t *pData, int size, uint16_t remote_id);
#endif
...
#else
    static int setWrite(uint8_t reg_address, uint8_t *pData, int size, uint16_t remote_id);
#endif
...
#else
    static int useFunction(uint8_t reg_address, uint8_t *params, int param_size, uint8_t *pData, int size, uint16_t remote_id);
#endif
...
#else
    static int writeTXBufferData(uint8_t data[], int size, int offset);
#endif
...
#else
    static int getLastNetworkId(uint16_t *network_id, uint16_t remote_id);
#endif
...
#else
    static int getLastDataLength(uint8_t *data_length, uint16_t remote_id);
#endif
...
#else
    static int setNetworkId(uint16_t network_id, uint16_t remote_id);
#endif
...
#else
    static int getUWBSettings(UWB_settings_t *UWB_settings, uint16_t remote_id);
#endif
...
#else
    static int setUWBSettings(UWB_settings_t *UWB_settings, uint16_t remote_id);
#endif
...
#else
    static int setUWBSettingsExceptGain(UWB_settings_t *UWB_settings, uint16_t remote_id);
#endif
    /**
...
#else
    static int setUWBChannel(int channel_num, uint16_t remote_id);
#endif
...
#else
    static int getUWBChannel(int* channel_num, uint16_t remote_id);
#endif
...
#else
    static int setTxPower(float txgain_dB, uint16_t remote_id);
#endif
...
#else
    static int getTxPower(float* txgain_dB, uint16_t remote_id);
#endif
...
#else
    static int getWhoAmI(uint8_t *whoami, uint16_t remote_id);
#endif
...
#else
    static int getFirmwareVersion(uint8_t *firmware, uint16_t remote_id);
#endif
...
#else
    static int getHardwareVersion(uint8_t *hardware, uint16_t remote_id);
#endif
...
#else
    static int getSelftest(uint8_t *selftest, uint16_t remote_id);
#endif
...
#else
    static int getErrorCode(uint8_t *error_code, uint16_t remote_id);
#endif
...
#else
    static int getInterruptStatus(uint8_t *interrupts, uint16_t remote_id);
#endif
...
#else
    static int getCalibrationStatus(uint8_t *calibration_status, uint16_t remote_id);
#endif
...
#else
    static int getGPIO(int gpio_num, uint8_t *value, uint16_t remote_id);
#endif
...
#else
    static int setGPIO(int gpio_num, uint8_t value, uint16_t remote_id);
#endif
...
#else
    static void resetSystem(uint16_t remote_id);
#endif
...
#else
    static int setLed(int led_num, bool state, uint16_t remote_id);
#endif
...
#else
    static int getInterruptMask(uint8_t *mask, uint16_t remote_id);
#endif
...
#else
    static int setInterruptMask(uint8_t mask, uint16_t remote_id);
#endif
...
#else
    static int getConfigModeGPIO(int gpio_num, uint8_t *mode, uint16_t remote_id);
#endif
...
#else
    static int getConfigPullGPIO(int gpio_num, uint8_t *pull, uint16_t remote_id);
#endif
...
#else
    static int setConfigGPIO(int gpio_num, int mode, int pull, uint16_t remote_id);
#endif
...
#else
    static int setLedConfig(uint8_t config, uint16_t remote_id);
#endif
...
#else
    static int configInterruptPin(int pin, int mode, int bActiveHigh, int bLatch, uint16_t remote_id);
#endif
...
#else
    static int saveConfiguration(int type, uint8_t registers[], int num_registers, uint16_t remote_id);
#endif
...
#else
    static int saveRegisters(uint8_t registers[], int num_registers, uint16_t remote_id);
#endif
...
#else
    static int saveNetwork(uint16_t remote_id);
#endif
...
#else
    static int saveAnchorIds(uint16_t remote_id);
#endif
...
#else
    static int saveUWBSettings(uint16_t remote_id);
#endif
...
#else
    static int clearConfiguration(uint16_t remote_id);
#endif
...
#else
    static bool isRegisterSaved(uint8_t regAddress, uint16_t remote_id);
#endif
...
#else
    static int getNumRegistersSaved(uint16_t remote_id);
#endif
 ...
 */
...
#else
    static int getCoordinates(coordinates_t *coordinates, uint16_t remote_id);
#endif
...
#else
    static int setCoordinates(coordinates_t coordinates, uint16_t remote_id);
#endif
...
#else
    static int getPositionError(pos_error_t *pos_error, uint16_t remote_id);
#endif
...
#else
    static int setPositioningAnchorIds(uint16_t anchors[], int anchor_num, uint16_t remote_id);
#endif
...
#else
    static int getPositioningAnchorIds(uint16_t anchors[], int anchor_num, uint16_t remote_id);
#endif
...
#else
    static int getUpdateInterval(uint16_t *ms, uint16_t remote_id);
#endif
...
#else
    static int setUpdateInterval(uint16_t ms, uint16_t remote_id);
#endif
...
#else
    static int getRangingProtocol(uint8_t *protocol, uint16_t remote_id);
#endif
...
#else
    static int setRangingProtocol(uint8_t protocol, uint16_t remote_id);
#endif
...
#else
    static int getPositionFilterStrength(uint8_t *filter_strength, uint16_t remote_id);
#endif
...
#else
    static int getPositionFilterType(uint8_t *filter_type, uint16_t remote_id);
#endif
...
#else
    static int setPositionFilter(uint8_t filter_type, uint8_t filter_strength, uint16_t remote_id);
#endif
...
#else
    static int getPositionAlgorithm(uint8_t *algorithm, uint16_t remote_id);
#endif
...
#else
    static int getPositionDimension(uint8_t *dimension, uint16_t remote_id);
#endif
...
#else
    static int setPositionAlgorithm(int algorithm, int dimension, uint16_t remote_id);
#endif
...
#else
    static int getAnchorSelectionMode(uint8_t *mode, uint16_t remote_id);
#endif
...
#else
    static int getNumberOfAnchors(uint8_t *nr_anchors, uint16_t remote_id);
#endif
...
#else
    static int setSelectionOfAnchors(int mode, int nr_anchors, uint16_t remote_id);
#endif
...
#else
    static int getOperationMode(uint8_t *mode, uint16_t remote_id);
#endif
...
#else
    static int setOperationMode(uint8_t mode, uint16_t remote_id);
#endif
    ...
    */
#ifdef __cplusplus
    static Pozyx_error_t getSystemError(uint16_t remote_id = NULL);
#else
    static Pozyx_error_t getSystemError(uint16_t remote_id);
#endif
...
#else
    static int getSensorMode(uint8_t *sensor_mode, uint16_t remote_id);
#endif
...
#else
    static int setSensorMode(uint8_t sensor_mode, uint16_t remote_id);
#endif
...
#else
    static int getRawSensorData(sensor_raw_t *sensor_raw, uint16_t remote_id);
#endif
...
#else
    static int getAllSensorData(sensor_data_t *sensor_data, uint16_t remote_id);
#endif
...
#else
    static int getPressure_Pa(float32_t *pressure, uint16_t remote_id);
#endif
...
#else
    static int getMaxLinearAcceleration(uint16_t *max_lin_acc, uint16_t remote_id);
#endif
...
#else
    static int getAcceleration_mg(acceleration_t *acceleration, uint16_t remote_id);
#endif
...
#else
    static int getMagnetic_uT(magnetic_t *magnetic, uint16_t remote_id);
#endif
...
#else
    static int getAngularVelocity_dps(angular_vel_t *angular_vel, uint16_t remote_id);
#endif
...
#else
    static int getEulerAngles_deg(euler_angles_t *euler_angles, uint16_t remote_id);
#endif
...
#else
    static int getQuaternion(quaternion_t *quaternion, uint16_t remote_id);
#endif
...
#else
    static int getLinearAcceleration_mg(linear_acceleration_t *linear_acceleration, uint16_t remote_id);
#endif
...
#else
    static int getGravityVector_mg(gravity_vector_t *gravity_vector, uint16_t remote_id);
#endif
...
#else
    static int getTemperature_c(float32_t *temperature, uint16_t remote_id);
#endif
...
#else
    static int doPositioning(coordinates_t *position, uint8_t dimension, int32_t height);
#endif
...
#else
    static int doRemotePositioning(uint16_t remote_id, coordinates_t *coordinates, uint8_t dimension, int32_t height);
#endif
...
#else
    static int getDeviceRangeInfo(uint16_t device_id, device_range_t *device_range, uint16_t remote_id);
#endif
...
#else
    static int getDeviceListSize(uint8_t *device_list_size, uint16_t remote_id);
#endif
...
#else
    static int getDeviceIds(uint16_t devices[], int size, uint16_t remote_id);
#endif
...
#else
    static int getAnchorIds(uint16_t anchors[], int size, uint16_t remote_id);
#endif
...
#else
    static int getTagIds(uint16_t tags[], int size, uint16_t remote_id);
#endif
...
#else
    static int doDiscovery(int type, int slots, int slot_duration);
#endif
...
#else
    static int doAnchorCalibration(int dimension, int num_measurements, int num_anchors, uint16_t anchors[],  int32_t heights[]);
#endif
...
#else
    static int clearDevices(uint16_t remote_id);
#endif
...
#else
    static int addDevice(device_coordinates_t device_coordinates, uint16_t remote_id);
#endif
...
#else
    static int getDeviceCoordinates(uint16_t device_id, coordinates_t *coordinates, uint16_t remote_id);
#endif
